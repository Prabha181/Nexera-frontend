        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-gray-600">
              <Link to="/" className="hover:text-[#45A735]">
                Home
              </Link>{" "}
              &nbsp;–&nbsp; Contact us
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 rounded-lg overflow-hidden shadow-xl gap-8">
            {/* Contact Info */}
            <div className="bg-[#12431D] text-white p-6 sm:p-8 space-y-8 rounded-lg">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div className="flex items-start gap-4" key={idx}>
                    <div className="bg-[#A7F659] p-3 rounded-full text-black">
                      {item.icon}
                    </div>
                    <div>
            ...
            <div className="col-span-2 bg-white p-6 sm:p-10 rounded-lg">
              <form className="space-y-6">
                ...
                <button
                  className="mb-6 relative h-12 w-36 bg-[#78EB54] text-black shadow-2xl rounded-full flex items-center justify-center text-sm font-medium overflow-hidden transition-all
