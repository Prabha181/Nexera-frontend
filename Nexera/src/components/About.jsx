    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-sm text-gray-600">
          <Link to="/" className="text-sm font-medium text-gray-500 hover:text-[#45A735] transition-colors">
            Home
          </Link> &nbsp;–&nbsp; us
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full max-w-md sm:max-w-lg mx-auto aspect-square">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-full shadow-xl px-4 py-3 sm:px-6 sm:py-4 flex items-center space-x-2 sm:space-x-3 hover:shadow-2xl transition-shadow duration-300">
              <div className="rounded-full p-2 sm:p-3 flex items-center justify-center bg-[#45a735]">
              ...
              <div className="text-left">
                ...
                <div className="text-gray-900 text-sm sm:text-base font-bold uppercase tracking-[0.02em] hover:text-[#45A735]">
                  +912 (556) 889
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="inline-block px-4 py-1 mb-3 rounded-full border border-[#bbf7d0] bg-[#ecfdf5] shadow-sm">
              <span className="text-[10px] uppercase font-bold tracking-[0.1em] text-[#45a735]">
                About Us
              </span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight">
              The most loved <span className="text-[#45a735]">Agency</span>
            </h1>
            <p className="text-[15px] text-gray-600 leading-relaxed font-semibold -mt-2">
              Voted the fastest solution to implement and easiest to administer your 
              employee & business.
            </p>
              ...
              {awards.map((award, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="bg-[#45A735] w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full text-white text-xl">
                      {award.icon}
                    </div>
                    <div>
                      <h3 className="text-black font-semibold text-sm sm:text-base leading-tight mb-1">
                        {award.title}
                      </h3>
