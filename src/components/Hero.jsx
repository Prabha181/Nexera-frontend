...
const Hero = () => {
  return (
    <div
      className="min-h-[670px] flex flex-col items-center justify-center text-center px-4 sm:px-6 bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: `url(${BusinessImg})` }}
    >
      <div className="bg-black/50 h-full absolute top-0 left-0 z-0" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-base sm:text-lg md:text-xl text-white max-w-2xl mx-auto leading-relaxed">
          Step into a world where your skills are valued, your growth is prioritized,
          <br className="hidden sm:block" />
          and your next big move is just a click away.
        </p>

        <div className="mt-10 flex flex-col sm:flex-row gap-4 w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto justify-center items-center">
          <button
