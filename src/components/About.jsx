      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full max-w-md sm:max-w-lg mx-auto aspect-square">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-full shadow-xl px-4 py-3 sm:px-6 sm:py-4 flex items-center space-x-2 sm:space-x-3 hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="text-left">
                ...
                <div className="text-gray-900 text-sm sm:text-base font-bold uppercase tracking-[0.02em] hover:text-[#3574b8]">
                  +912 (556) 889
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            At Nexera, we connect top talent with forward-thinking companies, 
             bringing both sides of the hiring journey onto one seamless platform.
            </p>
             <p className="text-[15px] text-gray-600 leading-relaxed font-semibold -mt-2">
