...
const Footer = () => {
  return (
    <footer className="text-gray-700 pt-1 pb-6 bg-[#e6edf8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col items-center sm:items-start text-center sm:text-left">
            <img src="/src/assets/nexeralogo.png" alt="JobAway Logo" className="w-28 mb-3" />
                ...
                {section.items.map((item) => (
                  <li key={item}>
                    <a
                      ...
                      style={{ color: 'inherit' }}
                      onMouseEnter={(e) => (e.target.style.color = '#3574b8')}
                      onMouseLeave={(e) => (e.target.style.color = 'inherit')}
                      onMouseDown={(e) => (e.target.style.color = '#3574b8')}
                      onMouseUp={(e) => (e.target.style.color = '#3574b8')}
                    >
                      {item}
                    </a>
                  </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-600 gap-4 md:gap-0">
          <p className="text-center md:text-left">
            ...
            <a
              ...
              style={{ color: '#3574b8' }}
              onMouseEnter={(e) => (e.target.style.color = '#14243d')}
              onMouseLeave={(e) => (e.target.style.color = '#3574b8')}
            >
              JobAway
            </a>{' '}
            All rights reserved.
          ...
          <div className="flex items-center space-x-4 justify-center md:justify-start">
            ...
            {[Facebook, Twitter, Linkedin, Dribbble].map((Icon, idx) => (
              <a
                ...
                className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-[#3574b8] hover:text-white transition-colors"
              >
