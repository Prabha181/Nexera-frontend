...
const WorkOptions = () => {
  return (
    <div className="bg-white py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-10">
        {/* Job Providers */}
        <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 flex flex-col items-center text-center relative w-full">
          ...
          <button
            className="mb-10 sm:mb-6 relative h-11 sm:h-12 w-32 sm:w-36 bg-[#3574b8] text-white shadow-2xl rounded-full flex items-center justify-center text-sm font-medium overflow-hidden transition-all
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 flex flex-col items-center text-center relative w-full">
          ...
          <button
            className="mb-5 sm:mb-6 relative h-11 sm:h-12 w-32 sm:w-36 bg-[#3574b8] text-white shadow-2xl rounded-full flex items-center justify-center text-sm font-medium overflow-hidden transition-all
              before:absolute before:left-0 before:top-0 before:h-full before:w-0 before:duration-500
              after:absolute after:right-0 after:top-0 after:h-full after:w-0 after:duration-500
              hover:before:w-1/2 hover:before:bg-[#14243d]
              hover:after:w-1/2 hover:after:bg-[#14243d]
